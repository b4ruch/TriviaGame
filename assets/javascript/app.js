...
*Homework 5: JavaScript Assignment 2          *
...
const WAIT_RESULT = 4;      //Seconds to show the result
const WAIT_QUESTION = 10;    //Seconds for timeout
var correct;
var incorrect;
...
function gameOver() {
    ...
    var correctAns = $("<h5>").addClass("score");
    correctAns.text("Correct Answers: " + correct);

    var incorrectAns = $("<h5>").addClass("none");
